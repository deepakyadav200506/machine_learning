...
### Overview
This project predicts whether a person is Diabetic or Not based on 
medical input parameters using a Machine Learning classification model.
<br>
this project is part of a flipped course evaluation 
